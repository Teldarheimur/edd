...
pub enum Statement {
    Express(Box<Type>, Expr),
    Let(Rc<str>, Box<Type>, Expr),
    Var(Rc<str>, Box<Type>, Expr),
...
pub enum Expr {
    ...
    Cast(Box<Self>, Box<Type>, Box<Type>),
    ...
    Eq(Box<Self>, Box<Self>, Box<Type>),
    Neq(Box<Self>, Box<Self>, Box<Type>),
    Lt(Box<Self>, Box<Self>, Box<Type>),
    Lte(Box<Self>, Box<Self>, Box<Type>),
    Gt(Box<Self>, Box<Self>, Box<Type>),
    Gte(Box<Self>, Box<Self>, Box<Type>),
